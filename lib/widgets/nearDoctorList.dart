  ...
  getLatLong() {
    ...
    data.then((value) async {
      ...
      if (widget.selectedValue == 'Chest Diseases') {
        url = 'http://127.0.0.1:5000/NearbyPulmonologistDoctors';
      } else if (widget.selectedValue == 'Liver Tumor') {
        url = 'http://127.0.0.1:5000/NearbyHepatologistDoctors';
      } else if (widget.selectedValue == 'Kidney Tumor') {
        url = 'http://127.0.0.1:5000/NearbyKidneyTumorDoctors';
      } else {
        url = 'http://127.0.0.1:5000/NearbyBreastCancerDoctors';
      }
